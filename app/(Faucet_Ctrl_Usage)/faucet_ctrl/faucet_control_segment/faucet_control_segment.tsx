    ...
    <div className="flex justify-center items-center w-full  mt-2">
      <div className="flex flex-wrap w-[85%] bg-white">
        <div className="w-full sm:w-1/3 sm:flex-none p-4">
          ...
          />
          <ControlButton
            options={solenoidActivationDurationOptions}
        ...
        <div className="w-full sm:w-2/3 sm:flex-none  p-4 flex flex-col">
          <div className="flex-1  p-4">
            <ControlButton
              options={maxIRWaterCheckDurationOptions}
          ...
          <div className="flex-3  p-4 flex w-full ">
            <div className="flex flex-grow-2  p-2 flex-col">
              <ControlButton
                options={auto1secStartStopSwitchOptions}
                segmentTitle="啟動1S/S自動開關"
              />
              <ControlButton
                options={carbonCreditReductionOptions}
                segmentTitle="減少多少碳權"
              />
              <div className="flex justify-start items-center">
                <ControlButton
                  options={energySavingModeOptions}
                  segmentTitle="進入省電時間"
                />
            ...
            <div className="flex flex-grow-2  p-2 flex-col">
              <ControlButton
                options={autoFlushing12hrOptions}
                segmentTitle="12小時自動沖水時間"
              />
              <ControlButton
                options={irSensingDurationOptions}
