                        ...
                        {selected ? (
                          <span className="absolute inset-y-0 left-0 flex items-center pl-2 text-sky-600">
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                d="M16.707 5.293a1 1 0 01.083 1.32l-.083.094-7.293 7.293a1 1 0 01-1.32.083l-.094-.083-4-4a1 1 0 011.32-1.497l.094.083L9 12.585l6.293-6.292a1 1 0 011.414 0z"
                                clipRule="evenodd"
                              />
                            </svg>
                          </span>
